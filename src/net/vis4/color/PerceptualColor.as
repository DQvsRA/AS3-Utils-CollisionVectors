package net.vis4.color 
{
	...
	public class PerceptualColor extends EventDispatcher
	{
		...
		public function setHSV(h:Number, s:Number, v:Number):void {
			if (_mode != HSV) throw new Error('value not supported in ' + _mode + ' mode'); 
		...
		public function setHSI(h:Number, s:Number, i:Number):void {
			if (_mode != HSI) throw new Error('intensity not supported in ' + _mode + ' mode'); 
		...
		public function setHSL(h:Number, s:Number, l:Number):void {
			if (_mode != HSL) throw new Error('lightness not supported in ' + _mode + ' mode'); 
		...
		public function setHSB(h:Number, s:Number, b:Number):void {
			if (_mode != HSB) throw new Error('brightness not supported in ' + _mode + ' mode'); 
