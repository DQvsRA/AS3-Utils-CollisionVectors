package
{
	...
	public class SortingVectors extends Sprite
	{
		...
		public static function shellSort(data:Vector.<Point>): void
		{
		...
		public static function f(p1:Point, p2:Point): int
		{
			return p1.x - p2.x;
		}
 
		// http://www.kirupa.com/developer/actionscript/quickSort.htm
		public static function quickSort(arrayInput:Vector.<Point>, left:int, right:int): Vector.<Point>
		{
			var i:int = left;
			var j:int = right;
